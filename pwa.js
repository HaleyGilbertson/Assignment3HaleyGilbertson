...
const cacheName = 'Assignment3HaleyGilbertson-2021-10-01 13:29:43.996265'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'Assignment3HaleyGilbertson'.length) === 'Assignment3HaleyGilbertson') {
